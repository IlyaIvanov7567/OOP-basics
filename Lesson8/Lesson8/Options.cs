                ...
                case 1:
                    {
                        ...
                        try
                        {
                            ...
                            Console.WriteLine("The total size of the subfolders within this directory is: " + Utilities.FileSizeFormat(totalSize));
                            Console.WriteLine();
                        }
                        catch (ArgumentException)
                        {
                ...
                case 7:
                    {
                        ...
                        {
                            Console.ForegroundColor = ConsoleColor.Green;
                            Console.WriteLine(ObjectManager.CountSymbolsInFile(input));
                        }
                        catch (ArgumentException)
                        {
                            Console.ForegroundColor = ConsoleColor.Red;
                ...
                case 8:
                    {
                        ...
                        {
                            Console.ForegroundColor = ConsoleColor.Green;
                            Console.WriteLine(ObjectManager.CountLinesInFile(input));
                        }
                        catch (ArgumentException)
                        {
                            Console.ForegroundColor = ConsoleColor.Red;
                ...
                case 9:
                    {
                        ...
                        {
                            Console.ForegroundColor = ConsoleColor.Green;
                            Console.WriteLine(ObjectManager.CountWordsInFile(input));
                        }
                        catch (ArgumentException)
                        {
                            Console.ForegroundColor = ConsoleColor.Red;
