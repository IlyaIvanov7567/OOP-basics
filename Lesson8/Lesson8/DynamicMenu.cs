...
namespace Lesson8
{
    ...
    {
        public static string[] mainMenu = { "Get list of files in directory", "Get list of folders in directory", "Manage files", "Manage folders", "Quit" };
        public static string[] filesMenu = { "Create file", "Delete file", "Move file", "Rename File", "Read text from file", "Write text to file", "Search file for text", "Symbols count in file", "Lines count in file", "Words count in file", "Return to MAIN MENU" };
